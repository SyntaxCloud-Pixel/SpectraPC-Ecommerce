...
function Home() {
  ...
  return (
    <div>
      ...
      <div className="hero-section" style={{ padding: '80px 40px', backgroundColor: '#f9f9f9', textAlign: 'center' }}>
        ...
        <Link to="/cart" style={{
          backgroundColor: '#000', color: '#fff', padding: '14px 32px',
          borderRadius: '6px', textDecoration: 'none', fontSize: '16px', fontWeight: '500'
        }}>View Cart</Link>
      </div>
          ...
          {products.map(product => (
            <div key={product.id} style={{
              ...
              <div style={{ display: 'flex', gap: '8px' }}>
                ...
                <button style={{
                  padding: '10px 14px', backgroundColor: '#fff', border: '1px solid #eee',
